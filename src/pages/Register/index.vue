  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="width: 100px; height: 38px; vertical-align: top;" @click="getCode()">获取验证码</button>
      ...
      <div class="content">
        <label>确认密码:</label>
        <input type="password" placeholder="请输入确认密码" v-model="confirmPwd" name="confirmPwd" v-validate="{ required: true, is: password }" :class="{ invalid: errors.has('confirmPwd') }">
        <span class="error-msg">{{ errors.first('confirmPwd') }}</span>
      </div>
      <div class="controls">
...
export default {
  ...
  methods: {
    ...
    async userRegister() {
      ...
      if (success) {
        try {
          const { phone, code, password, confirmPwd } = this
